export default function LikeIcon(props : {toFill: boolean}) {

  return (
    <svg stroke="currentColor" stroke-width="80" fill="currentColor" fill-opacity={props.toFill ? "1" : "0"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="overflow: visible; color: currentcolor;" height="100%" width="100%">
